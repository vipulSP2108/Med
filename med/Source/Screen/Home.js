...
export default function Home({ route }) {
  ...
  const { fontsLoaded, userData, setUserData, doctorData, setDoctorData, fontFamilies, setMessMealData } = useContext(GlobalStateContext);
  ...
  const tools = [
    ...
    // { label: "Laundry & Schedule", icon: "logo-ionic", onPress: () => navigation.navigate('BusUserNavigationStack') },
    ...
    // { label: "Ride Fair Splitter", icon: "car-sport", onPress: () => navigation.navigate('SplitfareNavigationStack') },
    // 
    {
          ...
          <View style={[styles.verticalScrollContainer, { backgroundColor: themeColors.backGroundColor }]}>
            ...
            <View className=' px-3'>
              ...
              <View className=' pt-5 w-full flex-row justify-between'>
                ...
                {/* <TouchableOpacity
                  onPress={() => navigation.navigate('BusUserNavigationStack')}
                ...
                >
                  <View style={{ backgroundColor: themeColors.diffrentColorPerple, borderRadius: 23 }} className=' w-[57px] h-[57px] items-center justify-center'>
                    <Ionicons color={'white'} name={'bus-outline'} size={28} />
                  </View>
                  <Text className=' flex-wrap pt-2 text-center' style={[fontstyles.h5_5, { lineHeight: 14, color: themeColors.mainTextColor }]}>Bus & Schedule</Text>
                </TouchableOpacity> */}
                ...
                <TouchableOpacity
                  ...
                  <View
                    style={{ backgroundColor: themeColors.diffrentColorPerple, borderRadius: 12 }} className=' w-full h-[57px] items-center justify-center'>
                    <Ionicons color={'white'} name={'restaurant-outline'} size={28} />
                  </View>
                  <Text className=' flex-wrap pt-2 text-center' style={[fontstyles.h5_5, { lineHeight: 14, color: themeColors.mainTextColor }]}>Dinning & Reservation</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  ...
                  // onPress={() => navigation.navigate('OutletUserNavigationStack', { handleScroll: handleScroll })}
                  className=' w-[48%] items-center'>
                  <View style={{ backgroundColor: themeColors.diffrentColorPerple, borderRadius: 12 }} className=' w-full h-[57px] items-center justify-center'>
            ...
            <View style={{ backgroundColor: themeColors.componentColor }} className='mt-5 py-3 px-4 flex-row justify-between '>
              ...
              <View style={{ backgroundColor: themeColors.componentColor }} >
                <Text style={[fontstyles.h5_bold, { color: themeColors.mainTextColor }]} className=' uppercase '>Quick Links</Text>
                <ScrollView horizontal={true} scrollEnabled={true} showsHorizontalScrollIndicator={false} className="flex-row gap-3 mt-[0px]">

...
import SplitfareHomeScreen from '../ScreensSplitfareServices/SplitfareHomeScreen';
import CreateRide from '../ScreensSplitfareServices/CeateRide';

const Tab = createBottomTabNavigator();
export default function SplitfareBotttomStack() {
    ...
    return (
        <>
            ...
            <Tab.Navigator
                screenOptions={({ route }) => ({
                    ...
                    tabBarIcon: ({ focused }) => {
                        ...
                        if (route.name === 'SplitfareHomeScreen') {
                            iconName = focused ? 'home' : 'home-outline';
                        } else if (route.name === 'SplitfareOrders') {
                            iconName = focused ? 'bag-handle-sharp' : 'bag-handle-outline';
                        } else if (route.name === 'SplitfarCreateRide') {
            ...
            >
                <Tab.Screen name="SplitfareHomeScreen" component={SplitfareHomeScreen} />
                <Tab.Screen name="SplitfarCreateRide" component={CreateRide} />
                <Tab.Screen
                    options={{

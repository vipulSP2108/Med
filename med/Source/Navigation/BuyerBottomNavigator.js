...

      {
        userRole == 'Seller' ?
          ...
          >
            {
              userRole == 'Seller' ?
                <Tab.Screen name="Home" initialParams={{ handleScroll }} component={HomeSeller} /> :
                null
              // <Tab.Screen name="Home" initialParams={{ handleScroll }} component={Home} />
            }

            {
              ...
              //       // fontSize: 24,
              //     },
              //     // headerTintColor: themeColors.diffrentColorOrange,
              //   }}
              // />
            }
            {

...
import MessOrders from '../ScreensMessServices/MessOrders';

const Tab = createBottomTabNavigator();
export default function MessUserBottomStack() {
    ...
    return (
        <>
            ...
            <Tab.Navigator
                screenOptions={({ route }) => ({
                    ...
                    tabBarIcon: ({ focused }) => {
                        ...
                        if (route.name === 'MessHomeScreen') {
                            iconName = focused ? 'home' : 'home-outline';
                        } else if (route.name === 'MessOrders') {
            ...
            >
                ...
                <Tab.Screen name="MessHomeScreen" component={MessHomeScreen} />
                <Tab.Screen
                    options={{
